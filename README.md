...
```
cd existing_repo
git remote add origin https://gitlab.univ-nantes.fr/E188424J/stage-5a-proposition.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.univ-nantes.fr/E188424J/stage-5a-proposition/-/settings/integrations)
